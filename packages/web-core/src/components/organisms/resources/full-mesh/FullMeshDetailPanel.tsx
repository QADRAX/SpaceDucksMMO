...
export function FullMeshDetailPanel({ resource, versions }: { resource: ResourceSummary; versions: VersionSummary[] }) {
        ...
        <div className="flex h-full">
          <ResourceDialogFormPanel onSubmit={async (e) => {
            ...
            <div className="space-y-2">
              ...
              <Input type="number" step={0.01} min={0} placeholder="e.g. 1.25" value={boundingRadius} onChange={(e) => setBoundingRadius(e.target.value)} />
            ...
            <div className="space-y-2">
              ...
              <Input type="text" placeholder="clip name" value={defaultClip} onChange={(e) => setDefaultClip(e.target.value)} />
            </div>
          ...
          <ResourceDialogPreviewPanel>
            <ModelFilePreview
              ...
              showAnimations
              onAnimations={(a) => { if (a && a.length && !defaultClip) setDefaultClip(a[0].name); }}
            />
          </ResourceDialogPreviewPanel>
        </div>
      </ResourceDialogLayout>
...
export default FullMeshDetailPanel;
