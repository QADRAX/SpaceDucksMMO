...
export function CreateFullMeshResourceDialog({ kindLabel }: { kindLabel: string }) {
        ...
        <div className="flex h-full w-full flex-col">
          ...
          <div className="flex min-h-0 flex-1">
              ...
              <form className="space-y-6" onSubmit={onSubmit}>
                ...
                {animations.length > 0 && (
                  <div className="space-y-2">
                    ...
                    <select className="w-full p-2 border border-border rounded" value={selectedClip} onChange={(e) => setSelectedClip(e.target.value)}>
            ...
            <div className="min-w-0 flex-1 bg-bg">
              <LocalGlbFilePreview file={meshFile} onDropFile={(f) => setMeshFile(f)} className="h-full w-full" showAnimations onAnimations={(a) => { setAnimations(a); if (a && a.length && !selectedClip) setSelectedClip(a[0].name); }} />
            </div>
          </div>
        </div>
      </DialogContent>
...
export default CreateFullMeshResourceDialog;
