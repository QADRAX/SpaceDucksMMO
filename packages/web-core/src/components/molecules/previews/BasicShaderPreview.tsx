...
import { BasicShaderPreviewScene } from './scenes/BasicShaderPreviewScene';
...
export function BasicShaderPreview({ resourceKey, shaderSource, uniforms, componentData, className, onError }: Props) {
    const [previewSettings, setPreviewSettings] = usePreviewSettings(
        resourceKey,
        'webcore.preview.basicShader',
            ...
            async resolve(key: string, version) {
                if ((shaderSource !== undefined && key === resourceKey) || key.startsWith('dev-')) {
                    ...
                    return {
                        ...
                        resourceId: key,
                        version: 1,
                        componentType: 'basicShaderMaterial',
    ...
    const scene = React.useMemo(() => {
        ...
        return new BasicShaderPreviewScene(settings, shaderId, previewSettings, uniforms, componentData);
...
export default BasicShaderPreview;
