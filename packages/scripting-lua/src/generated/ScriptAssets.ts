...
export const BuiltInScripts: Record<string, string> = {
  "builtin://continuous_rotator": `-- Rotates the entity continuously around a world axis.
...
`,
  "builtin://debug_logger": `-- Debug logging helper for inspecting game state.
...
`,
  "builtin://empty": `-- Basic no-op script for testing.
-- Every script must have at least an init() function.

return {
  init = function()
    print("Empty script initialized")
  end
}
`,
  "builtin://physics_movement": `-- Moves a rigidbody using physics-based forces and WASD input.
...
`,
  "builtin://spawn_emitter": `-- Simple periodic emitter spawning copies of this entity.
