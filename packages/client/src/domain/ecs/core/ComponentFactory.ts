...
import PointLightComponent from "@client/domain/ecs/components/light/PointLightComponent";
import SpotLightComponent from "@client/domain/ecs/components/light/SpotLightComponent";
