...
export class StandardMaterialComponent extends BaseMaterialComponent {
  ...
  readonly metadata: ComponentMetadata = {
    ...
    inspector: {
      fields: [
        { key: 'color', label: 'Color', get: (c: StandardMaterialComponent) => c.color, set: (c, v) => { c.color = v as any; } },
        { key: 'metalness', label: 'Metalness', get: (c: StandardMaterialComponent) => c.metalness, set: (c, v) => { c.metalness = Number(v); } },
        { key: 'roughness', label: 'Roughness', get: (c: StandardMaterialComponent) => c.roughness, set: (c, v) => { c.roughness = Number(v); } },
        { key: 'emissive', label: 'Emissive', get: (c: StandardMaterialComponent) => c.emissive, set: (c, v) => { c.emissive = v as any; } },
        { key: 'emissiveIntensity', label: 'Emissive Intensity', get: (c: StandardMaterialComponent) => c.emissiveIntensity, set: (c, v) => { c.emissiveIntensity = Number(v); } },
        { key: 'transparent', label: 'Transparent', get: (c: StandardMaterialComponent) => c.transparent, set: (c, v) => { c.transparent = Boolean(v); } },
        { key: 'opacity', label: 'Opacity', get: (c: StandardMaterialComponent) => c.opacity, set: (c, v) => { c.opacity = Number(v); } },
        { key: 'texture', label: 'Texture', get: (c: StandardMaterialComponent) => c.texture, set: (c, v) => { c.texture = v as any; } },
        { key: 'normalMap', label: 'Normal Map', get: (c: StandardMaterialComponent) => c.normalMap, set: (c, v) => { c.normalMap = v as any; } },
        { key: 'envMap', label: 'Env Map', get: (c: StandardMaterialComponent) => c.envMap, set: (c, v) => { c.envMap = v as any; } },
      ],
    },
  };
