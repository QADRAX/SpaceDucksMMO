...
/**
 * Sandbox scene - Testing and prototyping environment with full solar system
 * Same as main menu scene but editable via Scene Editor UI
 */
export function createSandboxSceneDefinition(textureResolver: TextureResolverService): SceneDefinition {
  return SceneFactory.define(SceneId.Sandbox)
    ...
    .addObject(StarBuilder.create('sandbox-sun', textureResolver, {
      radius: 1.0,
      textureId: 'sun',
