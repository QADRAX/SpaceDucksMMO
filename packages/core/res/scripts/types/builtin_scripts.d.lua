...
---@field targetEntityId LuaEntity Target entity to follow.
...
---@field targetEntityId LuaEntity Target entity to look at.
...
---@field targetEntityId LuaEntity Central entity to orbit around.
