...
`,
  "test://component_bridge_skin_animator.lua": `-- E2E test: Component bridge for skin (ResourceRef skeleton) and animator (playback fields).
...
return {
  ...
  init = function(self)
    ...
    self.properties.playingReadBack = animData and animData.playing == true
